		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple Smart Form",
									"targetURL": "#student01saptrainingux402smartfield-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student01saptrainingux402smartfield-display": {
								"semanticObject": "student01saptrainingux402smartfield",
								"action": "display",
								"description": "Simple Smart Form",
								"title": "Simple Smart Form",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student01.sap.training.ux402smartfield",
									"url": sap.ui.require.toUrl("student01/sap/training/ux402smartfield")
								}
							}
						}
					}
