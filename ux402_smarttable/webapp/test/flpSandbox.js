		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Table 01",
									"targetURL": "#student01saptrainingux402smarttable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student01saptrainingux402smarttable-display": {
								"semanticObject": "student01saptrainingux402smarttable",
								"action": "display",
								"description": "Smart Table 01",
								"title": "Smart Table 01",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student01.sap.training.ux402smarttable",
									"url": sap.ui.require.toUrl("student01/sap/training/ux402smarttable")
								}
							}
						}
					}
